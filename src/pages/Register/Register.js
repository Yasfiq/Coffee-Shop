...
const Register = () => {
  ...
  const register = (event) => {
    ...
    if (
      ...
      errorMessage !== "Must be filled completely!"
    ) {
      ...
      <div className="grid grid-cols-12">
        ...
        <section className="p-10 col-span-6 h-screen overflow-y-scroll font-rubik">
          ...
          <form className="mx-auto mb-5 w-3/4" onSubmit={register}>
            <label htmlFor="name" className="text-xl block font-medium">
              Name :
            </label>
            <input
              type="text"
              ...
              className="placeholder:text-base w-full text-xl mt-3 rounded-2xl py-4 px-5 border-2 border-blold/30"
            />
            <label
              htmlFor="username"
              className="mt-6 text-xl block font-medium"
            >
              Username :
            </label>
            <input
            ...
            <input
              ...
              className="placeholder:text-base w-full text-xl mt-3 rounded-2xl py-4 px-5 border-2 border-blold/30"
            />
            <label htmlFor="email" className="mt-6 text-xl block font-medium">
              Email Address :
            </label>
            <input
              type="email"
              ...
              className="placeholder:text-base w-full text-xl mt-3 rounded-2xl py-4 px-5 border-2 border-blold/30"
            />
            <p className="text-xl mt-4 text-red-500 font-rubik font-medium">
              {errorMessage}
            </p>
            <button type="submit" className="btn-primary text-2xl mt-10 w-full">
              Sign Up
            </button>
            <button className="btn-third text-2xl w-full mt-5">
              <img src={googleIcon} alt="google-icon" className="mr-3 inline" />
              Sign up with Google
            </button>
            <p className="text-base my-4 relative bg-white z-[2] w-max px-2 mx-auto text-blold/50">
